...
$target = 'http://afsaccess2.njit.edu/~db368/CS490_git/CS490-Test-Website-Frontend/Druswitch.php';
$ch= curl_init();
...
$_POST['id'] = $_POST['eid'];
$target = 'http://afsaccess2.njit.edu/~db368/CS490_git/CS490-Test-Website-Frontend/eexam.php';
$ch= curl_init();
curl_setopt($ch, CURLOPT_URL, "$target");
curl_setopt($ch, CURLOPT_POST, 1); // Set it to post
